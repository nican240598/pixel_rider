    ...
    <div className="py-6 max-w-5xl mx-auto px-4">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl">
        ...
        <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-purple-950 via-slate-950 to-purple-950 border border-purple-800/40 p-6 md:p-8 text-center mb-8 shadow-xl">
          <div className="w-20 h-20 rounded-full bg-slate-900 border-2 border-amber-400 overflow-hidden flex items-center justify-center mx-auto mb-3 shadow-[0_0_20px_rgba(250,204,21,0.3)]">
            {avatarUrl ? (
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold uppercase text-white tracking-tight mb-1">
            {username}
          </h2>

          <p className="text-xs text-purple-200/80 uppercase font-semibold tracking-wider mb-4">
            Pixel Rider Community Member
          </p>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-8 bg-slate-950 p-2 rounded-2xl border border-slate-800">
          <button
            onClick={() => setActiveTab('all')}
            className={`px-5 py-2.5 rounded-xl text-xs font-extrabold uppercase transition-all cursor-pointer border-0 ${
              activeTab === 'all'
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-xs font-extrabold uppercase transition-all cursor-pointer border-0 flex items-center gap-1.5 ${
              activeTab === 'garage'
                ? 'bg-amber-500 text-black shadow-lg'
                : 'bg-transparent text-slate-400 hover:text-white'
            }`}
          >
            <Wrench className="w-4 h-4" /> Garage ({userBikes.length})
          </button>
          <button
          ...
          >
            <MessageSquare className="w-4 h-4" /> Foren Beiträge ({userTopics.length})
          </button>
          <button
          ...
          >
            <Map className="w-4 h-4" /> GPX Routen ({userRoutes.length})
          </button>
        </div>
