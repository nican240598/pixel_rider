      ...
      <div className="flex gap-2 overflow-x-auto pb-4 mb-6 scrollbar-none">
        {['Alle', 'Fahrzeug', 'Teile', 'Kleidung', 'Sonstiges'].map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-full text-xs font-bold uppercase transition-all whitespace-nowrap border-0 cursor-pointer ${
              selectedCat === cat
              ...
              >
                <div>
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-xs text-purple-400 mt-1">Verkäufer: <strong>{item.author}</strong></p>
